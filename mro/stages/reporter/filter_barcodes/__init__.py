...
def split(args):
    return {'chunks': [{}], 'join': {'__mem_gb': 20.0}}
...
def join(args, outs, chunk_defs, chunk_outs):
    ...
    if args.barcodes:
        ...
        if len(n99_bcs) > 1:
            ...
            (coa_bc_tbl, coa_graph) = coa_calc.coalescence_analysis()
            ...
            # write out barcode overlap graph
            with open(outs.barcode_graph, "wb") as f:
                cPickle.dump(coa_graph, f, protocol=2)
