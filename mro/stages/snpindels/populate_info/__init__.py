...
def main(args, outs):
    ...
    if not precalled and args.haploid_merge is not None:
        ...
        merge_haploid(outfile, args.haploid_merge, args.locus, output_filename, bam, reference_pyfasta, args)
...
def merge_haploid(novel_vcf, putative_vcf, locus, output_filename, bam, reference_pyfasta, args):
