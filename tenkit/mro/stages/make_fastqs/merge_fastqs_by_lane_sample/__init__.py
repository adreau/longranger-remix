...
def split(args):
    ...
    rows = iem_df.as_matrix(['Sample_ID', 'Original_Sample_ID'])
    ...
    # encountered, it is given a monotonically increasing value.  This S-value will be
    # included in any FASTQs associated with that sample_ID, in the '_S#_' part of the file name.
    #
    ...
    # output file.
    for row in rows:
        demux_sample_id, original_sample_id = row
